...
alter table public.notifications add column if not exists author_id bigint;
alter table public.notifications add column if not exists author_name text;
alter table public.notifications add column if not exists author_avatar text;
